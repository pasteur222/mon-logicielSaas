/*
  # Fix permissions and add business subscriptions table
  ...
  2. Security
    ...
    - Update user_profiles policies to allow proper access

  3. Changes
    - Update user_profiles policies to allow proper access without relying on users table
*/
...
-- Update user_profiles policies to not rely on users table
